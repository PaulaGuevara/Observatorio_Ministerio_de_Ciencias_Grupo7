...
\caption{Indicador 4. Produccion por clasificacion: tabla por convocatoria.} \label{tab:ind04_conv} \\
\toprule
ID\_CONVOCATORIA & ANIO\_CONVOCATORIA & NME\_REGION\_GR & NME\_CLASIFICACION\_GR & productos \\
\midrule
\endfirsthead
\caption[]{Indicador 4. Produccion por clasificacion: tabla por convocatoria.} \\
\toprule
ID\_CONVOCATORIA & ANIO\_CONVOCATORIA & NME\_REGION\_GR & NME\_CLASIFICACION\_GR & productos \\
\midrule
\endhead
