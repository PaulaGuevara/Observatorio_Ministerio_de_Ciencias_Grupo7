...
\caption{Indicador 14. Participacion por clasificacion (%): tabla completa.} \label{tab:ind14_general} \\
\toprule
NME\_REGION\_GR & NME\_CLASIFICACION\_GR & productos & total\_productos\_region & participacion\_clasificacion\_region \\
\midrule
\endfirsthead
\caption[]{Indicador 14. Participacion por clasificacion (%): tabla completa.} \\
\toprule
NME\_REGION\_GR & NME\_CLASIFICACION\_GR & productos & total\_productos\_region & participacion\_clasificacion\_region \\
\midrule
\endhead
