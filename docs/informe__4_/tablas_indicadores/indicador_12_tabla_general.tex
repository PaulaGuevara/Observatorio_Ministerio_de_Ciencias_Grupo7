...
\caption{Indicador 12. Distribucion por genero registrado (%): tabla completa.} \label{tab:ind12_general} \\
\toprule
NME\_REGION\_GR & NME\_GENERO\_PR & productos & investigadores\_unicos & total\_productos\_region & participacion\_porcentual\_genero\_region & produccion\_promedio\_por\_investigador \\
\midrule
\endfirsthead
\caption[]{Indicador 12. Distribucion por genero registrado (%): tabla completa.} \\
\toprule
NME\_REGION\_GR & NME\_GENERO\_PR & productos & investigadores\_unicos & total\_productos\_region & participacion\_porcentual\_genero\_region & produccion\_promedio\_por\_investigador \\
\midrule
\endhead
