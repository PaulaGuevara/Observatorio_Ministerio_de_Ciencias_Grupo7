...
\caption{Indicador 5. Diversificacion de productos: tabla por convocatoria.} \label{tab:ind05_conv} \\
\toprule
ID\_CONVOCATORIA & ANIO\_CONVOCATORIA & NME\_REGION\_GR & tipologias\_distintas & productos\_considerados \\
\midrule
\endfirsthead
\caption[]{Indicador 5. Diversificacion de productos: tabla por convocatoria.} \\
\toprule
ID\_CONVOCATORIA & ANIO\_CONVOCATORIA & NME\_REGION\_GR & tipologias\_distintas & productos\_considerados \\
\midrule
\endhead
