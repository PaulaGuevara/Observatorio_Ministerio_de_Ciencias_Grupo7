\begin{longtable}{llr}
\caption{Indicador 4. Produccion por clasificacion: tabla completa.} \label{tab:ind04_general} \\
\toprule
NME\_REGION\_GR & NME\_CLASIFICACION\_GR & productos \\
\midrule
\endfirsthead
\caption[]{Indicador 4. Produccion por clasificacion: tabla completa.} \\
\toprule
NME\_REGION\_GR & NME\_CLASIFICACION\_GR & productos \\
\midrule
\endhead
